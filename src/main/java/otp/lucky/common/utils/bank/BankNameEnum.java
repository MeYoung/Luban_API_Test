...
public enum BankNameEnum {
     ...
     */
    ABC("103", "中国农业银行", "农行",
            new Integer[]{552599, 404119, 404121, 519412, 403361, 558730, 520083, 520082, 519413, 49102, 404120, 404118, 53591, 404117, 622848, 622836, 622837},
            new Integer[]{}),
    /**
     * <pre>
     * 中国银行
     ...
     */
    BOC("104", "中国银行", "中行",
            new Integer[]{622760, 409666, 438088, 622752},
            new Integer[]{}),
    /**
     * <pre>
     * 中国建设银行
     ...
     */
    CCB("105", "中国建设银行", "建行",
            new Integer[]{622280,436745,436742},
            new Integer[]{}),
    /**
     * <pre>
     * 交通银行
     ...
     */
    BCOM("301", "交通银行", "交行",
            new Integer[]{622260,521899,458123},
            new Integer[]{}),
    /**
     * <pre>
     * 中信银行
     ...
     */
    CITIC("302", "中信银行",
            new Integer[]{622690,520108,376968,376966,622918,622916,376969,622919,556617,403391,558916,514906,400360,433669,433667,433666,404173,404172,404159,404158,403393,403392,622689,622688,433668,404157,404171,404174,628209,628208,628206},
            new Integer[]{622680,518212}),
    /**
     * <pre>
     * 中国光大银行
    ...
    CEB("303", "中国光大银行",
            new Integer[]{},
            new Integer[]{406254,622655,622650,622658,356839,486497,481699,543159,425862,406252,356837,356838,356840,622161,628201,628202}),
    /**
     * <pre>
     * 华夏银行
     * 华夏银行：539867,528709
    ...
    HXB("304", "华夏银行",
            new Integer[]{},
            new Integer[]{539867,528709,523959,622637,622636,528708,539868}),
    /**
     * <pre>
     * 中国民生银行
     * 民生银行：407405,517636
    ...
    CMBC("305", "中国民生银行",
            new Integer[]{421870},
            new Integer[]{415599,512466,407405,517636,528948,552288,556610,622600,622601,622602,622603,421869,421871,628258,622622}),
    /**
     * <pre>
     * 广东发展银行
    ...
    CGB("306", "广东发展银行",
            new Integer[]{},
            new Integer[]{622568,548844,911121,520382,520152,622568}),
    /**
     * <pre>
     * 平安银行
    ...
    PAB("307", "平安银行",
            new Integer[]{},
            new Integer[]{622155,622156,528020,526855,435744,622526,435745,998801,998802,622525,622538}),
    /**
     * <pre>
     * 招商银行
     ...
     * 招商银行VISA白金卡：439188
     * 招商银行VISA信用卡普通卡：439225
     * 招商银行VISA信用卡金卡：439226
     * </pre>
     */
    CMB("308", "招商银行", "招行",
            new Integer[]{439225,439226,356889,518710},
    ...
    CIB("309", "兴业银行",
            new Integer[]{},
            new Integer[]{451289,622902,622901,527414,524070,486493,486494,451290,523036,486861,622922}),
    /**
     * <pre>
     * 上海浦东发展银行
    ...
    SPDB("310", "上海浦东发展银行",
            new Integer[]{},
            new Integer[]{498451,622517,622518,515672,517650,525998,356850,356851,356852}),
    ...
    BON("", "宁波银行",
            new Integer[]{},
            new Integer[]{512431,520194,622318,622778});
