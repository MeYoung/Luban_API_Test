package com.luban.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://xx.xx.xx.xx:3306/xxxxx?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    ...
    // @author 值
    private static final String AUTHOR = "shijin.huang";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.luban.generator";
    // xml文件路径
